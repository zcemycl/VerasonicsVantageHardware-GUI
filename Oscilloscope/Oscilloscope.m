...
% voltage-axis
amplitude                           = 30 ;% from the signal generator [V]
% auto (0) or fixed (1)
yaxisstate                          = 0;
% ---------------------------------------------------------------------- %
...
Event(n).seqControl = 5;
n = n+1;
% if any change occurs, including the change of amplification, when the 
% number of averages is greater than 1, the system could not short-ciruit 
% but automatically clash. 
% hope to make a shortcircuit event  so that any change can cause jumping 
% back to event 1
% if 
